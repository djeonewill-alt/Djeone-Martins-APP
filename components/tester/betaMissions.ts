...
export const betaMissions: BetaMission[] = [
  ...
  },
  {
    ...
    step_by_step: [
      'Abra a Aba Hoje.',
      'Lembre-se: este é um teste do Beta Fechado.',
      'Compartilhe apenas com você mesmo no WhatsApp ou no grupo oficial dos testadores beta.',
      'Não envie para pessoas fora do grupo beta.',
      ...
      'Se abrir a tela de compartilhamento, escolha enviar para você mesmo no WhatsApp ou para o grupo oficial dos testadores beta.',
      'No WhatsApp, verifique se aparece imagem de preview, título, descrição e link.',
      'Toque no link e confira se abre a página da Palavra do Dia com imagem.',
      ...
      'No WhatsApp, verifique se o áudio mostra imagem de preview, título, descrição e link.',
      'Toque no link do áudio e confira se abre a página do episódio com opção de ouvir.',
    ...
    what_to_observe: [
      ...
      'Se o WhatsApp mostra imagem de preview, título e descrição.',
      'Se ficou claro que o teste não deve ser enviado para fora do grupo beta.',
    ],
